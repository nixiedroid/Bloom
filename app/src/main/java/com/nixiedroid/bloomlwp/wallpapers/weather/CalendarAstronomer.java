...
//android / platform / external / icu / d4d3fc6 / . / android_icu4j / src / main / java / android / icu / impl / CalendarAstronomer.java
//https://android.googlesource.com/platform/external/icu/+/d4d3fc6/android_icu4j/src/main/java/android/icu/impl/CalendarAstronomer.java
...
//    }
    ...
    public static final class Horizon {
        ...
        @NotNull
        public String toString() {
            return altitude * RAD_DEG + "," + (azimuth*RAD_DEG);
        }
